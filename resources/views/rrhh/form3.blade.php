<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-3">
            ...
            value="{{old('sol_justificacion', $data->sol_justificacion ?? '')}}" onkeyup="javascript:this.value=this.value.toUpperCase();" required  disabled>
        </div>
    </div>


    <div class="form-group row">
        <label for="mon_simbolo" class="col-sm-12 col-lg-5 control-label text-sm-left text-lg-right "> Formulario para Subir Evidencia</label>
        <div class="col-lg-1">
            <A HREF="https://forms.office.com/r/z9QQdrJwip">
                Formulario para Subir Evidencia</A>
    </div>
